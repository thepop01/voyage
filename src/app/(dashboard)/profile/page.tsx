  ...
  return (
    <div className="glass-panel" style={{ padding: 32 }}>
      <form onSubmit={handleAdd} style={{ display: "flex", gap: 16, marginBottom: 32, alignItems: "center" }}>
        ...
        <button type="submit" className="glass-button" style={{ padding: "14px 24px", borderRadius: 8, background: "#E6F2DD", color: "#fff", border: "none" }}>
          Add Wallet
        </button>
      </form>
  ...
  return (
    <div style={{ paddingBottom: 100, maxWidth: 1000, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div style={{ width: 120, height: 120, borderRadius: "50%", background: "#E6F2DD", padding: 4, flexShrink: 0, position: "relative", zIndex: 1 }}>
