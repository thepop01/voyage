          ...
          <div className="grid" style={{ gridTemplateColumns: "1fr", gap: 16, marginTop: 0 }}>
            <div className="dense-card" style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 24, marginBottom: 0 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                <span style={{ color: "#fff", fontWeight: "bold" }}>+10 REP</span>
            ...
            <div className="dense-card" style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 24, marginBottom: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                <div style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(88,101,242,0.1)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <aside>
          ...
          <div className="dense-card" style={{ padding: 0, overflow: "hidden" }}>
            <div style={{
              ...
              <h3 style={{ display: "flex", alignItems: "center", gap: 10, color: "#fff", marginBottom: 4 }}>
              ...
              {[
                ...
                <div key={i} style={{ 
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
                    <span style={{ color: "#fff", fontWeight: "bold", fontSize: "0.7rem" }}>+10 REP</span>
                    <button className="glass-button" style={{
                      padding: "4px 12px",
                      fontSize: "0.7rem",
                      borderRadius: 6,
